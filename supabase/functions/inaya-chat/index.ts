...
`;
  ...
  if (effectiveLang === "uk") {
    return `Ти Inaya, УНІВЕРСАЛЬНИЙ AI асистент з покупок. Відповідай УКРАЇНСЬКОЮ мовою.
...
- Будь корисним і швидким`;
  ...
  if (effectiveLang === "en") {
    return `You are Inaya, a UNIVERSAL AI shopping assistant. Respond in ENGLISH.
...
- Be helpful and fast`;
  ...
  return `Te vagy Inaya, egy UNIVERZÁLIS AI shopping asszisztens. Magyar nyelven válaszolsz.
