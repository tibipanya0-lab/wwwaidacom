  ...
  const articles = [
    {
      ...
      content:
        "Hogyan sürgetnek az órákkal, amik valójában sosem járnak le. Sok webshop úgy működik, hogy a visszaszámláló végén egyszerűen újraindul – mintha mindig 'utolsó esélyed' lenne. Aida figyeli az árakat hosszú távon, és megmutatja, mikor valódi az akció, és mikor csak marketing trükk.",
    },
    {
      icon: Layers,
      title: "Kuponhalmozás",
      content:
        "Miért érdemesebb néha két kisebb kupont használni egy nagy helyett (ha a rendszer engedi). Egyes webshopok lehetővé teszik több kupon kombinálását – ilyenkor egy 10%+5% kombináció jobb lehet, mint egy 12%-os egyedülálló kupon. Aida mindig a legjobb kombinációt keresi neked.",
    },
    {
      icon: Camera,
      title: "Kép alapú keresés ereje",
      content:
        "Hogyan találhatod meg ugyanazt a terméket feleannyiért egy másik eladónál, csak egy fotó alapján. Töltsd fel a képet a keresőbe, és Aida megkeresi neked ugyanazt (vagy nagyon hasonló) terméket a legjobb áron – akár más boltban, akár más eladónál.",
    },
    {
      icon: Package,
      title: "Vám és szállítás",
      content:
        'Mire figyelj, hogy a "filléres" cucc a végén ne legyen drágább, mintha itthon vetted volna. 150€ felett vámot és ÁFA-t kell fizetned, ami akár 30-40%-kal is megdrágíthatja a rendelést. Aida figyelmezteti, ha a kosár értéke közelít ehhez a határhoz.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-amber-500/10 to-yellow-500/10 rounded-2xl border border-amber-500/30 p-6 md:p-8 mb-10">
            <div className="flex items-start gap-4">
              <AidaAvatar size="md" />
              <div>
                <p className="text-white font-medium mb-2">Szia, Aida vagyok! 👋</p>
